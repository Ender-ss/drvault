  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[var(--color-brand)] blur-[120px] rounded-full" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[var(--color-brand)] blur-[120px] rounded-full" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[var(--color-brand)] rounded-2xl mb-6 shadow-lg shadow-[var(--color-brand)]/20 rotate-12">
            <Key className="w-8 h-8 text-white -rotate-12" />
          </div>
          <h1 className="text-3xl font-extrabold tracking-tight text-white mb-2">DRVault</h1>
          <p className="text-[var(--color-text-muted)] font-medium">Sua biblioteca definitiva de Direct Response</p>
        </div>
        ...
        <p className="text-center mt-8 text-xs text-[var(--color-text-muted)]">
          &copy; {new Date().getFullYear()} DRVault. Todos os direitos reservados.
        </p>
      </div>
    </div>
  );
